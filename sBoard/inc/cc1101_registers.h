...
//GDO0 Definitions
#define GDO2_PxOUT        P1OUT
#define GDO2_PxIN         P1IN
#define GDO2_PxDIR        P1DIR
#define GDO2_PxIE         P1IE
#define GDO2_PxIES        P1IES
#define GDO2_PxIFG        P1IFG
#define GDO2_PxREN        P1REN
#define GDO2_PIN          BIT2

//LED port definitions
#define LED_PxOUT         P3OUT
#define LED_PxDIR         P3DIR
#define LED1              BIT6
#define LED2              BIT6
